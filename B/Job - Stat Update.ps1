...
$scriptblock = {
 ...
 $ping = "Online"
    ...
    Try {
    $create1 = schtasks.exe /CREATE /TN "Update Stat" /S $args /SC ONCE /ST 23:00 /RL HIGHEST /RU SYSTEM /TR "powershell.exe -noprofile -File '\\xltats.ps1'" /F
