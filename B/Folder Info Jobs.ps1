...
$ScriptBlock = {
    ...
    ForEach ($File in $Files)
    {
        ...
        $Results | Export-Csv "C:\U$($args[0]) Cleanup Scan.csv" -Append -Force
    }

    #ForEach ($Item in $Items)
    #{
    #    Move-Item -Path $Item.FullName -Destination "\\5kup" -Force
    #}
    ...
    $Results2 | Export-Csv "C:\up Data.csv" -Append -Force
}
