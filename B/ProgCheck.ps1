...
Function ProgCheck
{
    If (Test-Path -Path "C:\Users\\Documents\ProgCheck.txt")
    {
        Remove-Item -Path "C:\Users\\Documents\ProgCheck.txt" -Force
    }
    "Computer; Program; Version" | Out-File "C:\Users\\Documents\ProgCheck.txt" -Force
    ...
    ForEach ($Computer in $Computers)
    {
        If (Test-Connection $Computer -Quiet -BufferSize 16 -Ea 0 -Count 1)
        {
                ...
                ForEach($Key in $SubKeys)
                {
                    ForEach ($Identifer in $Identifers)
                    {
                        If ($Key -like $Identifer)
                        {
                            ...
                            "$Computer; $Display; $Version" | Out-File "C:\Users\\Documents\ProgCheck.txt" -Append -Force
                        }
                    }
                }
            }
            Catch
            {
                "$Computer; Access Denied" | Out-File "C:\Users\\Documents\ProgCheck.txt" -Append -Force
            }
        ...
        Else
        {
            ...
            "$Computer; Offline" | Out-File "C:\Users\\Documents\ProgCheck.txt" -Append -Force
        }
        Write-Host
    }
    $File = "C:\Users\\Documents\ProgCheck.txt"
