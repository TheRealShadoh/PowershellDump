...
#Target List
$Comps = Get-Content "C:\Users\1394844760A\Desktop\scripting test bed\office.txt"
#Program key
$program = "{26A24AE4-039D-4CA4-87B4*"   #Put program ID here with the * ending it as shown
